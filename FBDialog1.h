...
@interface FBDialog1 : UIView <UIWebViewDelegate> {
 ...
 */
- (void)dialogDidComplete:(FBDialog1 *)dialog;
 ...
 */
- (void)dialogDidNotComplete:(FBDialog1 *)dialog;

/**
 * Called when dialog failed to load due to an error.
 */
- (void)dialog:(FBDialog1*)dialog didFailWithError:(NSError *)error;
 ...
 */
- (BOOL)dialog:(FBDialog1*)dialog shouldOpenURLInExternalBrowser:(NSURL *)url;
